          ...
          >
            ...
            <div className="max-w-6xl mx-auto relative">
              ...
              >
                ...
                >
                  Uniting skilled electricians across every state to promote
                  safe practices, fair wages, and professional growth. Together,
                  we power the nation.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    ...
                    <p className="leading-relaxed mb-4 text-gray-600">
                      The All India Electrician Association (AIEA) was founded
                      to be the unified voice of India's electrician community.
                      We are committed to upholding professional standards,
                      ensuring worker safety, and advocating for fair
                      compensation.
                    </p>
